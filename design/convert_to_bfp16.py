...
parser.add_argument('-m', '--mode', help='two conversion mode: bf16, bf_fp_16')
...
if args.mode =='bf16':#convert model to full bfloat16
...
if args.mode =='bf_fp_16': #convert model part is float16, part is bfloat16 for inference
    ##################################change model initializer###################################
    for i, j in enumerate(all_initializer):
        # change sigmoid initializer (fp32 -> bf16)
        if j.name[-21:] == 'Sigmoid_Exp_ln2_value':
